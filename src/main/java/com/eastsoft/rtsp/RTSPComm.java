...
//	private final String address = "rtsp://129.1.6.89/mpeg4cif";
	private final String address = "rtsp://218.204.223.237:554/live/1/66251FC11353191F/e7ooqwcfbqjoo80j.sdpu";
	private int seq = 0;
...
//				+ response + "\"\r\n");
		sb.append("User-Agent: LibVLC/2.1.5 (LIVE555 Streaming Media v2014.05.27)\r\n");
		//Transport: RTP/AVP/TCP 若需要使用UDP传输视频数据，可将TCP改为UDP
